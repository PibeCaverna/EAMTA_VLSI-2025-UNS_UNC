...
N 150 0 190 0 {lab=Z}
N -120 60 -120 100 {lab=ab}
N -150 100 -120 100 {lab=ab}
N 410 -100 410 -40 {lab=vdd}
N 410 50 410 110 {lab=vss}
N 320 -0 350 -0 {lab=a}
N 470 -0 510 -0 {lab=ab}
N -220 60 -170 60 {lab=vss}
N -220 -40 -170 -40 {lab=vdd}
N -70 0 -70 10 {lab=vout}
N -70 0 30 0 {lab=vout}
N 330 -440 330 -380 {lab=b}
N -230 10 -170 10 {lab=b}
...
C {lab_pin.sym} -160 -60 0 0 {name=p10 sig_type=std_logic lab=a}
C {lab_pin.sym} -150 100 0 0 {name=p19 sig_type=std_logic lab=ab}
C {lab_pin.sym} 410 -100 0 0 {name=p15 sig_type=std_logic lab=vdd}
C {lab_pin.sym} 410 110 0 0 {name=p18 sig_type=std_logic lab=vss}
C {lab_pin.sym} 320 0 0 0 {name=p20 sig_type=std_logic lab=a}
C {lab_pin.sym} 510 0 2 0 {name=p21 sig_type=std_logic lab=ab}
C {lab_pin.sym} -220 -40 0 0 {name=p2 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -220 60 0 0 {name=p13 sig_type=std_logic lab=vss}
C {lab_pin.sym} 330 -440 0 0 {name=p3 sig_type=std_logic lab=b}
C {lab_pin.sym} -230 10 0 0 {name=p17 sig_type=std_logic lab=b}
C {lab_pin.sym} -20 0 1 0 {name=p22 sig_type=std_logic lab=vout}
C {/foss/designs/sch/inverter.sym} 410 0 0 0 {name=x2}
C {/foss/designs/sch/inverter.sym} 90 0 0 0 {name=x3}
C {/foss/designs/sch/TG.sym} -120 10 0 0 {name=x1}
