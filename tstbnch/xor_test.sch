...
N -140 -130 -140 -60 {lab=vdd}
N -230 -10 -170 -10 {lab=a}
N -140 60 -140 120 {lab=vss}
N 90 40 90 100 {lab=vss}
N 140 0 190 0 {lab=Z}
...
C {lab_pin.sym} -140 -130 0 0 {name=p2 sig_type=std_logic lab=vdd}
C {lab_pin.sym} -140 120 0 0 {name=p3 sig_type=std_logic lab=vss}
C {lab_pin.sym} 90 100 0 0 {name=p4 sig_type=std_logic lab=vss}
...
C {lab_pin.sym} 330 -410 1 0 {name=p17 sig_type=std_logic lab=b}
C {/foss/designs/sch/inverter.sym} 90 0 0 0 {name=x2}
C {/foss/designs/sch/xor.sym} -110 0 0 0 {name=x1}
